...
import xueluoanping.cuisine.block.nature.BlockBambooLeaves;
...
public class BlockRegister {
    ...
    public static final DeferredHolder<Block, BlockBamboo> bamboo =
            DRBlocks.register("bamboo", () -> new BlockBamboo(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT)
                    .forceSolidOn().strength(2.0f).sound(SoundType.BAMBOO).noOcclusion()));
    ...
    public static final DeferredHolder<Block, BlockBambooLeaves> bamboo_branch_leaves =
            DRBlocks.register("bamboo_branch_leaves",
                    () -> new BlockBambooLeaves(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).strength(2.0f).sound(SoundType.CROP).noOcclusion().dynamicShape()));
