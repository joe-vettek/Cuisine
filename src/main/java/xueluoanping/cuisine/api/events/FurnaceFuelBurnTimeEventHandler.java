package xueluoanping.cuisine.api.events;
 ...
 *  If you just need to set the burn time for your own item, override Item.getItemBurnTime(ItemStack) instead, it's simpler
 */
