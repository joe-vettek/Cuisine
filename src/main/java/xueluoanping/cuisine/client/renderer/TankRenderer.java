...
public class TankRenderer {
	 ...
	 */
	public static void renderFluids(PoseStack matrices, MultiBufferSource buffer,
									BlockPos tankMinPos, BlockPos tankMaxPos, int brightness) {
		List<FluidStack> fluids = new ArrayList<>();
		FluidStack fluidStackDown = new FluidStack(new WaterFluid() {
			@Override
