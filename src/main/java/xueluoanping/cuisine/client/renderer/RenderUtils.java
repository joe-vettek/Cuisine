...
public final class RenderUtils {
   ...
   */
  public static void renderFluidTank(PoseStack matrices, MultiBufferSource buffer, FluidCuboid cube, FluidStack liquid, int light, float partialTicks, boolean flipGas) {
...
//      }
      ...
      FluidRenderer.renderScaledCuboid(matrices, buffer, cube, liquid, 0.8f, capacity, light, flipGas);
    } else {
