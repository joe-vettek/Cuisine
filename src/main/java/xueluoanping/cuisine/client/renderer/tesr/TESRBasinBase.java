...
public class TESRBasinBase {
	...
	static void drawBasin(ItemStack stack, int combinedLight, int combinedOverlay, PoseStack matrixStackIn, MultiBufferSource bufferIn, Level level, int posLong) {
